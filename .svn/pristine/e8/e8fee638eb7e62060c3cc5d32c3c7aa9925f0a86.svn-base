            ...
            <div class="big_right">
                ...
                <form>
                    ...
                    <ul>
                        <li class="zx">手机号码：</li>
                        <li>
                            <input type="text" id="mobilephone" class="box" value="<?=htmlspecialchars($user->mobilephone)?>"/>
                        </li>
                    </ul><br />
                    <ul>
                        <li class="zx">电子邮箱：</li>
                        <li><input type="text" id="email" class="box" value="<?=htmlspecialchars($user->email)?>"/>
                        </li>
                    </ul><br />
                    ...
                    <ul>
                        <li class="zx">邮政编码：</li>
                        <li>
                            <input type="text" id="postcode" class="box" value="<?=htmlspecialchars($user->postcode)?>"/>
                        </li>
                    </ul><br />
                </form>
