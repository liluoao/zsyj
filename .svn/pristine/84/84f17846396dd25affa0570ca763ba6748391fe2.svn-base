    ...
    <div class="content">
        <div class="content_top">
            <div class="content_nav">
                <a href="<?=yii::$app->urlManager->createUrl('fontadmin/personaldata')?>">我的紫薯</a><span>></span><a href="<?=yii::$app->urlManager->createUrl('fontadmin/orderafter')?>">我的订单</a><span>></span><a href="javascript:detail('<?=$userorderId?>');">订单详情</a></div>
            ...
            <div class="order_details">
                ...
                <div class="consignee">
                    ...
                    <?foreach($dictItem as $key=>$data){
                        if($userorder->orderState == $data->dictItemCode){
                            $userorder->orderState = $data->dictItemName;
                        }
                    }?>
                </div>
                <div class="trade">
                        ...
                        <?foreach ($productorders as $index => $val){?>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><a href="javascript:;"><?=$userorder->orderState?></a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
