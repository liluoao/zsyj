                    ...
                    <table width="100%" cellspacing="0" id="column_list">
                        ...
                        <?php foreach ($column as $index => $val){?>
                            ...
                            <tr align="left">
                                ...
                                <td align="center"><a href="javascript:detail('<?=$val['columnId']?>','<?=$val['title']?>')"><?=htmlspecialchars($val['title'])?></a></td>
                                <td align="center"><?=htmlspecialchars($val['url'])?></td>
                                <td align="center"><input type="text" style="width:200px;" id="ordeyBy" name="ordeyBy" class="input-text" value="<?=htmlspecialchars($val['ordeyBy'])?>"/></td>
                                <td align="center">
