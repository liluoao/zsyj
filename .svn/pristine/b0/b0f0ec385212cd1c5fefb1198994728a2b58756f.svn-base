...
<html lang="<?= Yii::$app->language ?>" xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <script type="text/javascript">
            ...
            var delUrl = "<?=yii::$app->urlManager->createUrl('contact/delete')?>"
            var delallUrl = "<?=yii::$app->urlManager->createUrl('contact/deleteall')?>"
        </script>
            ...
            <form name="myform" action="" method="post" id="myform" target="iframeId">
                <div class="table-list">
                    <table width="100%" cellspacing="0" id="article_list">
                        ...
                        <tr align="left">
                            <th width="50px"><input type="checkbox" id='check_box' onclick="selectall('id')"/>全选</th><th width="30px" align="center">序号</th><th width="160px" align="center">姓名</th><th width="350px" align="center">内容</th><th width="160px" align="center">电话</th><th width="160px" align="center">时间</th><th align="center">操作</th>
                        </tr>
                        </thead>
                        <tbody id="department_list_body">
                        <?if(!is_null($contacts)){?>
                            <?$ind = 0;?>
                        <?php foreach ($contacts as $index => $val){?>
                                <?$ind++;?>
                            <tr align="left">
                                ...
                                <td align="center">
                                    <a href="javascript:deleteMes('<?=$val['id']?>')">删除</a>
                                </td>
                           </tr>
                        <?}?>
                        <?}?>
                    ...
                    <div class="btn">
                        ...
                        <input type="button" class="buttondel" name="dosubmit" value="删除" onclick="if (confirm('您确定要删除这些留言吗？')) delopt();"/>
                    </div>
                    <div id="pages">
...
<form action="<?=yii::$app->urlManager->createUrl('contact/listall')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="contact/listall"/>
