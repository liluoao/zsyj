...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <script type="text/javascript">
            var insertUrl = "<?=yii::$app->urlManager->createUrl('inform/insert')?>";
            var listallUrl = "<?=yii::$app->urlManager->createUrl('inform/listall')?>";
            var chooseUrl  = "<?=yii::$app->urlManager->createUrl('inform/choose')?>";
        </script>
        <script type="text/javascript" src="js/admin/inform/add.js"></script>
    </head>
    <body>
        <div class="subnav" id="display1" >
            <div class="content-menu ib-a blue line-x"> <a class="on" href="javascript:;"><em>发布新通知</em></a> </div>
        </div>
        <div class="pad-lr-10">
                    ...
                    <div style='overflow-y:auto;overflow-x:hidden' class='scrolltable'>
                        <table width="100%" cellspacing="0" class="table_form contentWrap">
                            <tr>
                                <th>选择接收者：</th>
                                <td>
                                    <input type="button" style="width:100px;height:50px;" onclick="choose('<?=$id?>');" name="dosubmit" class="buttonsearch" value="选择接收者"/>
                                </td>
                            </tr>
                            <tr>
                                <th width="100">通知类别：</th>
                                <td><select name="informType" id="informType" style="width:180px;"><input type="hidden" id="id" value="<?=$id?>"/></td>
                            </tr>
                            <tr>
                                <th>通知标题：</th>
                                <td><input type="text" style="width:350px;" name="title" id="title"  class="input-text"/></td>
                            </tr>
                            <tr>
                                <th>正&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;文：</th>
