...
class UserController extends Controller
{
    ...
    */
    ...
    {
        if (Yii::$app->session['username'] == 'ly' || Yii::$app->session['username'] == 'lla' ||
            Yii::$app->session['username'] == 'xfk')
        {
            ...
            $this->menuModels = BackendMenu::findBySql('SELECT * from zsyj_backendmenu where id in
(SELECT menuId from zsyj_role_menu WHERE roleId ="'. Yii::$app->session['roleId'] .'" )')
                ->all();
        }
