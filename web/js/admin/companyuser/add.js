...
function add(){
	if($.formValidator.pageIsValid()){ // 表单提交进行校验
		var paraStr = '';
		paraStr = "username=" + $('#username').val() + "&postcode=" + $('#postcode').val() + "&password=" + $('#password').val() + "&mobilephone=" + $('#mobilephone').val()+ "&detailAddress=" + $('#detailAddress').val()+ "&email=" + $('#email').val()+ "&member=" + $('#member').val()+ "&point=" + $('#point').val() ;
		$.ajax({
			url: insertUrl,
			type: "post",
			dataType: "text",
