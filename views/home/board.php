...
<head>
    ...
    <script type="text/javascript">
        ...
        var boardUrl = "<?=yii::$app->urlManager->createUrl('home/board')?>";
    </script>
            ...
            <div class="leave">
                ...
                <form name="myform" id="myform">
                    <?if(yii::$app->session['username'] == null){?>
                        <input type="hidden" id="name" value="游客"/>
                        <input type="hidden" id="userId" value=""/>
                    <?}else{?>
                        <input type="hidden" id="name" value="<?=yii::$app->session['username']?>"/>
                        <input type="hidden" id="userId" value="<?=yii::$app->session['userId']?>"/>
                    <?}?>
...
<form action="<?=yii::$app->urlManager->createUrl('home/board')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="home/board"/>
