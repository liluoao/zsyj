...
<html lang="<?= Yii::$app->language ?>" xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <script type="text/javascript">
            ...
            var editUrl = "<?=yii::$app->urlManager->createUrl('companyuser/edit')?>";
            var deleteUrl = "<?=yii::$app->urlManager->createUrl('companyuser/delete')?>"
            var deleteallUrl = "<?=yii::$app->urlManager->createUrl('companyuser/deleteall')?>"
            var detailUrl = "<?=yii::$app->urlManager->createUrl('companyuser/detail')?>"
            var resetUrl = "<?=yii::$app->urlManager->createUrl('companyuser/reset')?>"
        </script>
        <script language="javascript" type="text/javascript" src="js/admin/companyuser/listall.js" charset="utf-8"></script>
        <script language="javascript" type="text/javascript" src="js/page.js" charset="utf-8"></script>
    </head>
    <body>
        <div class="pad-lr-10">
            <div class="table-list">
                <table width="100%" cellspacing="0" id="frontuser_list">
                    <thead id="dict_list_head">
                    <tr align="left">
                        <th width="80px"><input type="checkbox" id='check_box' onclick="selectall('id')"/>全选/取消</th><th width="30px">序号</th><th width="100px">公司名称</th><th width="80px">电话号码</th><th width="80px" align="center">状态</th><th width="160px" align="center">注册时间</th><th width="80px" align="center">用户等级</th><th width="80px" align="center">积分</th><th width="80px" align="center">邮编</th><th align="center">操作</th>
                    </tr>
                    </thead>
                    <tbody id="frontuser_list_body">
                    <?if(!is_null($users)){?>
                    <?php foreach ($users as $index => $val){?>
                        <tr align="left">
                            ...
                            <td align="center"><?=$val->registerTime?></td>
                            <td align="center"><?=$val->member?></td>
                            <td align="center"><?=$val->point?></td>
                            <td align="center"><?=$val->postcode?></td>
                            <td align="center">
...
<form action="<?=yii::$app->urlManager->createUrl('companyuser/listall')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="companyuser/listall"/>
