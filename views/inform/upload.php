...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <script type="text/javascript" src="js/admin/inform/upload.js"></script>
    </head>
    <body>
        <form id="uploadForm" name="form1" method="post" action="<?=yii::$app->urlManager->createUrl('inform/upload')?>" enctype="multipart/form-data">
