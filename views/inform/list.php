...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <script type="text/javascript" src="js/admin/inform/list.js"></script>
    </head>
    <body>
        <div class="subnav" id="display1" >
            <div class="content-menu ib-a blue line-x"> <a class="on" href="javascript:;"><em>通知列表</em></a> </div>
        </div>
        <div class="pad-lr-10">
                        ...
                        <td>
                            <div class="explain-col">
                                <div>
                                    ...
                                    &nbsp;&nbsp;通知类别：
                                    <select name="informType" id="informType" style="width:180px;">
                                    ...
                                    &nbsp;&nbsp;
                                    <input type="button" name="dosubmit" class="buttonsearch" onclick="search();" value="查询"/>
                                </div>
                            </div>
                        </td>
                    </tr>
            ...
            <div class="table-list">
                <iframe id="iframeId" name="iframeId" src="<?=yii::$app->urlManager->createUrl('inform/listall')?>"  frameBorder=0 scrolling=no width="100%" onLoad="iFrameHeight()"></iframe>
            </div>
        </div>
    </body>
</html>