...
<head>
    ...
    <script type="text/javascript">
        ...
        var addUrl = "<?=yii::$app->urlManager->createUrl('material-cost/add')?>";
        var listallUrl = "<?=yii::$app->urlManager->createUrl('material-cost/listall')?>";
        var chooseUrl  = "<?=yii::$app->urlManager->createUrl('material-cost/choose')?>";
    </script>
    <script type="text/javascript" src="js/admin/cost/list.js"></script>
</head>
<body>
<div class="subnav" id="display" >
    <div class="content-menu ib-a blue line-x"> <a class="add fb" href="javascript:openadd();void(0);"><em>增加新消耗</em></a> </div>
</div>
<div class="pad-lr-10">
    ...
    <div class="table-list">
        <iframe id="iframeId" name="iframeId" src="<?=yii::$app->urlManager->createUrl('material-cost/listall')?>"  frameBorder=0 scrolling=no width="100%" onLoad="iFrameHeight()"></iframe>
    </div>
</div>
</body>
</html>