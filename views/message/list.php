...
<head>
    ...
    <script type="text/javascript">
        ...
        var listallUrl = "<?=yii::$app->urlManager->createUrl('message/listall')?>";
    </script>
    <script type="text/javascript" src="js/admin/message/list.js"></script>
</head>
<body>
<div class="pad-lr-10">
    <div class="subnav" id="display" >
        <div class="content-menu ib-a blue line-x">
            <a class="on" ><em>查看帖子</em></a>
        </div>
    </div>
    ...
    <div class="table-list">
        <iframe id="iframeId" name="iframeId" src="<?=yii::$app->urlManager->createUrl('message/listall')?>"  frameBorder=0 scrolling=no width="100%" onLoad="iFrameHeight()"></iframe>
    </div>
</div>
</body>
</html>