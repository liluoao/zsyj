...
<html lang="<?= Yii::$app->language ?>" xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <script type="text/javascript">
            ...
            var backUrl = "<?=yii::$app->urlManager->createUrl('message/back')?>";
            var delUrl = "<?=yii::$app->urlManager->createUrl('message/delete')?>"
            var delallUrl = "<?=yii::$app->urlManager->createUrl('message/deleteall')?>"
        </script>
        <script language="javascript" type="text/javascript" src="js/page.js" charset="utf-8"></script>
        <script language="javascript" type="text/javascript" src="js/admin/message/listall.js" charset="utf-8"></script>
            ...
            <form name="myform" action="" method="post" id="myform" target="iframeId">
                <div class="table-list">
                    <table width="100%" cellspacing="0" id="article_list">
                        ...
                        <tr align="left">
                            <th width="50px"><input type="checkbox" id='check_box' onclick="selectall('id')"/>全选</th><th width="30px" align="center">序号</th><th width="150px" align="center">用户名</th><th width="350px" align="center">帖子内容</th><th width="160px" align="center">发布时间</th><th align="center">操作</th>
                        </tr>
                        </thead>
                        ...
                        <?php foreach ($messages as $index => $val){?>
                            ...
                            <tr align="left">
                                ...
                                <td align="center"><?=htmlspecialchars($val['username'])?></td>
                                <td align="center"><?=htmlspecialchars($val['content'])?></td>
                                <td align="center"><?=$val['createDateTime']?></td>
                                <td align="center">
                                    <a href="javascript:openback('<?=$val['id']?>','<?=$val['username']?>')">回复</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:deleteMes('<?=$val['id']?>')">删除</a>
                                </td>
                           </tr>
                        <?}?>
                        <?}?>
                    ...
                    <div class="btn">
                        ...
                        <input type="button" class="buttondel" name="dosubmit" value="删除" onclick="if (confirm('您确定要删除这些帖子吗？')) delopt();"/>
                    </div>
                    <div id="pages">
...
<form action="<?=yii::$app->urlManager->createUrl('message/listall')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="message/listall"/>
