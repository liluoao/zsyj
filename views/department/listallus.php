...
<html lang="<?= Yii::$app->language ?>" xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <script type="text/javascript">
            var addallUrl = "<?=yii::$app->urlManager->createUrl('department/addall')?>";
        ...
        <script language="javascript" type="text/javascript" src="js/admin/department/listallus.js" charset="utf-8"></script>
    </head>
    <body>
        <div class="pad-lr-10">
            <form name="myform" action="" method="post" id="myform" target="center_frame">
                ...
                <table width="100%" cellspacing="0" id="user_list">
                    ...
                    <tr align="left">
                        <th width="80px"><input type="checkbox" id='check_box' onclick="selectall('id')"/>全选/取消</th><th width="30px" align="center">序号</th><th width="100px" align="center">用户名</th><th width="100px">真实姓名</th><th width="80px" align="center">性别</th><th width="160px" align="center">电话号码</th><th width="80px" align="center">用户状态</th>
                    </tr>
                    </thead>
                    ...
                    <?php foreach ($users as $index => $val){?>
                        <tr align="left">
                            ...
                            <td><?=htmlspecialchars($val->username)?></td>
                            <td><?=htmlspecialchars($val->truename)?></td>
                ...
                <div class="btn">
                    ...
                    <input type="button" class="buttonde" name="dosubmit" value="添加" onclick="adduserdep('<?=$departmentName?>','<?=$departmentId?>')"/>&nbsp;&nbsp;<input type="button" class="buttondel" name="dosubmit1" value="关闭" onclick="window.top.$.dialog.get('department_addu').close();"/>
                </div>
                <div id="pages">
...
<form action="<?=yii::$app->urlManager->createUrl('department/addus')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="department/addus"/>
