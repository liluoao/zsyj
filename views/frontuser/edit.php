...
<head>
    ...
    <script>
        var updateUrl = "<?=yii::$app->urlManager->createUrl('frontuser/update')?>";


    </script>
    <script language="javascript" type="text/javascript" src="js/admin/frontuser/edit.js" charset="utf-8"></script>
</head>
