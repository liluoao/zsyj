...
<html lang="<?= Yii::$app->language ?>" xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <script type="text/javascript">
            var editUrl = "<?=yii::$app->urlManager->createUrl('frontuser/edit')?>";
            var deleteUrl = "<?=yii::$app->urlManager->createUrl('frontuser/delete')?>"
            var deleteallUrl = "<?=yii::$app->urlManager->createUrl('frontuser/deleteall')?>"
            var detailUrl = "<?=yii::$app->urlManager->createUrl('frontuser/detail')?>"
            var resetUrl = "<?=yii::$app->urlManager->createUrl('frontuser/reset')?>"
        </script>
        <script language="javascript" type="text/javascript" src="js/admin/frontuser/listall.js" charset="utf-8"></script>
        ...
        <div class="pad-lr-10">
            <div class="table-list">
                <table width="100%" cellspacing="0" id="frontuser_list">
                    ...
                    <tr align="left">
                        <th width="80px"><input type="checkbox" id='check_box' onclick="selectall('id')"/>全选/取消</th><th width="30px">序号</th><th width="80px">用户名</th><th width="80px">真实姓名</th><th width="80px">电话号码</th><th width="40px" align="center">性别</th><th width="40px" align="center">状态</th><th width="160px" align="center">注册时间</th><th width="80px" align="center">用户等级</th><th width="40px" align="center">积分</th><th align="center">操作</th>
                    </tr>
                    </thead>
...
<form action="<?=yii::$app->urlManager->createUrl('frontuser/listall')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="frontuser/listall"/>
