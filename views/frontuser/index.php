...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
            var listUrl = "<?= Yii::$app->urlManager->createUrl('backend-menu/list')?>";
            var changepwdUrl = "<?= Yii::$app->urlManager->createUrl('user/changepwd')?>";
            var lockUrl = "<?= Yii::$app->urlManager->createUrl('login/lock')?>";
            var unlockUrl = "<?= Yii::$app->urlManager->createUrl('login/unlock')?>";
            $(function(){
        ...
        <script type="text/javascript" src="js/admin/user/changepwd.js"></script>
    </head>
                    ...
                    <div class="pad_10">
                        <div style='overflow-y:auto;overflow-x:hidden' class='scrolltable'>
                            ...
                            <table width="100%" cellspacing="0" class="table_form contentWrap">
                                ...
                                <tr>
                                    <th>原始密码：</th>
                                    <td><input type="password" style="width:200px;" id="oldPWD" class="input-text"/><div id="oldPWDTip" class="onShow">请输入原始密码</div></td>
                                </tr>
                                <tr>
                                    <th>新密码：</th>
                                    <td><input type="password" style="width:200px;" name="password" id="newPWD" value="" class="input-text"/><div id="newPWDTip" class="onShow">请输入新密码</div></td>
                                </tr>
                                <tr>
                                    <th>确认新密码：</th>
                                    <td><input type="password" style="width:200px;" id="newPWDAgain" value="" class="input-text"/><div id="newPWDAgainTip" class="onShow">请再次输入新密码</div></td>
                                </tr>
                            </table>
                        </div>
                        <div class="bk10"></div>
        ...
        <div class="header">
            ...
            <div class="col-auto" style="overflow: visible">
                <div class="log white cut_line">
                    您好！<?=Yii::$app->session['username']?>  [<?=Yii::$app->session['truename']?>]<span>|</span><a href="javascript:showBg();">[修改密码]</a><span>|</span><a href="<?=Yii::$app->urlManager->createUrl('login/logout')?>">[退出]</a><span>|</span><a href="/web/index.jsp" target="_blank">[前台主页]</a>
                </div>
