...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <script type="text/javascript" src="js/admin/product/uploads.js"></script>
    </head>
    <body>
        <form id="uploadForm" name="form1" method="post" action="<?=yii::$app->urlManager->createUrl(['product/upload','isThumb'=>'isThumb'])?>" enctype="multipart/form-data">
