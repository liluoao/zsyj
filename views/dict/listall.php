...
<html lang="<?= Yii::$app->language ?>" xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <script type="text/javascript">
            ...
            var editUrl = "<?=yii::$app->urlManager->createUrl('dict/edit')?>";
            var deldictUrl = "<?=yii::$app->urlManager->createUrl('dict/deldict')?>"
            var deldictallUrl = "<?=yii::$app->urlManager->createUrl('dict/delalldict')?>"
        </script>
                ...
                <table width="100%" cellspacing="0" id="dict_list">
                    ...
                    <?php foreach ($dicts as $index => $val){?>
                        <tr align="left">
                            ...
                            <td align="center"><a href="javascript:openedit('<?=$val->dictCode?>','<?=$val->dictName?>')">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:deleteDict('<?=$val->dictCode?>')">删除</a></td>
                        </tr>
                    <?}?>
                    <?}?>
                    </tbody>
...
<form action="<?=yii::$app->urlManager->createUrl('dict/listall')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page"/>
    <input type="hidden"  name="r" value="dict/listall"/>
