...
<head>
    ...
    <script type="text/javascript">
        ...
        var saveUrl = '<?=yii::$app->urlManager->createUrl('dict/save')?>';
...
<body>
<div class="pad-lr-10">
    <form action="<?=yii::$app->urlManager->createUrl('dict/save')?>" id="dictForm" name="dictForm" method="post" target="iframeId">
        <div class="pad_10">
