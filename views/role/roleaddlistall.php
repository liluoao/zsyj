...
<html lang="<?= Yii::$app->language ?>" xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <script type="text/javascript">
            ...
            var roleinsetUrl = "<?=yii::$app->urlManager->createUrl('role/roleinset')?>"
            var roleaddUrl = "<?=yii::$app->urlManager->createUrl('role/roleadd')?>"
        </script>
        <script language="javascript" type="text/javascript" src="js/admin/role/roleaddlistall.js" charset="utf-8"></script>
        ...
        <div class="pad-lr-10">
            <div class="table-list">
                <table width="100%" cellspacing="0" id="role_list">
                    ...
                    <tr align="left">
                        <th width="80px"><input type="checkbox" id='check_box' onclick="selectall('id')"/>全选/取消</th><th width="30px">序号</th><th width="160px">用户名</th><th width="160px">真实姓名</th><th width="160px">原始角色</th><th width="160px">电话号码</th><th width="80px" align="center">性别</th><th width="80px" align="center">用户状态</th>
                    </tr>
                    </thead>
                ...
                <div class="btn">
                    ...
                    <input type="button" class="buttonde" name="dosubmit" value="添加" onclick="adduserdep('<?=$name?>','<?=$roleId?>')"/>&nbsp;&nbsp;
                    <input type="button" class="buttondel" name="dosubmit1" value="关闭" onclick="window.top.$.dialog.get('role_roleadd').close();"/>
                </div>
                <div id="pages">
...
<form action="<?=yii::$app->urlManager->createUrl('role/roleaddlistall')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="role/roleaddlistall"/>
   ...
   <!-- <input type="hidden" id="username" name="username" value="<?/*=$para['username']*/?>"/>
    ...
    <input type="hidden" id="departmentName" name="departmentName" value="<?=$name?>"/>
</form>